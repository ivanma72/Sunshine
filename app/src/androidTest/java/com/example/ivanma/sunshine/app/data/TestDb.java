 ...
 */
package com.example.ivanma.sunshine.app.data;
...
public class TestDb extends AndroidTestCase {
    ...
    public void testCreateDb() throws Throwable {
        ...
        Log.v("testdb", locationColumnHashSet.toString());
    ...
    */
    public long testLocationTable() {
        ...
        assertTrue("Error: no records returned from location query", moveSucceeded);
        ...
        //Move cursor to demonstrate that there is only one record in the db
        assertFalse("Error: More than 1 record returned from location query", cursor.moveToNext());
    ...
    public void testWeatherTable() {
        ...
        ContentValues weatherValues = TestUtilities.createWeatherValues(rowId);
